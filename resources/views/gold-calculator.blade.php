...
<div class="container">
    <div class="p-5 my-4  rounded-3" style="background-color: #503211">
        <h3 style="color: white">Gold Weight Converter</h3>
        <hr style="color: white;">
        <p class="lead" style="color: white; text-align: justify;">
            This calculator provides an approximate value for the amount of fine (or pure) gold.
            {{-- It does not factor in intrinsic value that may apply to rare collectibles and coins or branded jewelry.
            Plus, the calculator provides market indications of what your gold is worth if it were in an investment grade form. --}}
        </p>
    </div>
    <div>
