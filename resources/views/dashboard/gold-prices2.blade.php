                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-body">
                                    ...
                                    <div class="card">
                                      ...
                                      foreach ($data as $d) { ?>
                                                    <tr <?php
                                                    if($d->created_at->isToday()){echo "style=' background-color: rgb(208 232 208);}'";} 
                                                    else{echo"style='background-color: rgb(255 233 233);'";}?>>
                                                                    ...
                                                                    <form class="modal-content" method="post"
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="col mb-0">
                                                                                ...
                                                                                class="form-label">Country<?php
                                                                                $data__ = \App\Models\Country::where('id', $d->country_id)->first();
                                                                                //  foreach ($data__ as $do) {  ?>
           
                                                                               <span style="margin-left: 30px;
                                                                                   font-size: 14px;
                                                                                   color: #0c36e0;"
                                                                               ><?php echo $data__->name_en; ?> </span></label>
                                                                           ...
                                                                           <div class="col mb-0">
                                                                            <label for="nameBackdrop"
                                                                            class="form-label">Unit<?php
                                                                            $data__ = \App\Models\GoldUnit::where('id', $d->unit_id)->first();
                                                                            // foreach ($data__ as $do) { ?>
...
{{-- 
                                                                            <div class="col mb-0">
                                                                               ...
                                                                               $data__ = \App\Models\Country::get();
                                                                                       ...
                                                                                       <option
                                                                                       <?php if($d->country_id == $do->id) echo "selected" ; ?>
                                                                            ...
                                                                            {{-- <div class="col mb-0">
                                                                               ...
                                                                               $data__ = \App\Models\GoldUnit::get();
                                                                                       ...
                                                                                       <option
                                                                                       <?php if($d->unit_id == $do->id) echo "selected" ; ?>
                                                                                       value="<?php echo $do->id; ?>"><?php echo $do->name_en; ?> </option>
