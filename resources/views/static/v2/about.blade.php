...
strong.price-strong {
    ...
    ">
            ...
            <div style="background: url({{url('assets/images/cover.jpg')}});
                ...
                <h3> <?php if($lang == 'en') {echo "About us";} else {echo "حولنا";}?></h3>
                <p><?php if($lang == 'en') {echo "sab_test Wallet app";} else {echo "تطبيق محفظة سبائك";}?></p>

            </div>
              <p>
                <?php $data=\App\Models\AppSetting::where('code', 'about')->first();
              if($lang == 'ar'){  echo $data->contents_ar;} else{ echo $data->contents_en;} ?>
